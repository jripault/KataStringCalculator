...
hljs.LANGUAGES.avrasm = function (a) {
    return {
        ...
        c: [a.CBLCLM, {cN: "comment", b: ";", e: "$"}, a.CNM, a.BNM, {
            cN: "number",
...
hljs.LANGUAGES.axapta = function (a) {
    return {
        ...
        c: [a.CLCM, a.CBLCLM, a.ASM, a.QSM, a.CNM, {cN: "preprocessor", b: "#", e: "$"}, {
            ...
            i: ":",
            k: "class interface",
            c: [{cN: "inheritance", bWK: true, k: "extends implements", r: 10}, {cN: "title", b: a.UIR}]
        }]
    }
}(hljs);
hljs.LANGUAGES.bash = function (a) {
    ...
    var b = {cN: "variable", b: /\$\{(.*?)\}/};
    var e = {cN: "string", b: /"/, e: /"/, c: [a.BE, c, b, {cN: "variable", b: /\$\(/, e: /\)/, c: a.BE}], r: 0};
...
hljs.LANGUAGES.brainfuck = function (a) {
    return {
        c: [{
            ...
            e: "[\\[\\]\\.,\\+\\-<> \r\n]",
            r: 0
        }, {cN: "title", b: "[\\[\\]]", r: 0}, {cN: "string", b: "[\\.,]", r: 0}, {cN: "literal", b: "[\\+\\-]"}]
    }
}(hljs);
...
hljs.LANGUAGES.coffeescript = function (c) {
    ...
    var d = [c.BNM, c.inherit(c.CNM, {starts: {e: "(\\s*/)?", r: 0}}), {
        ...
        e: "'''",
        c: [c.BE]
    }, {cN: "string", b: "'", e: "'", c: [c.BE], r: 0}, {cN: "string", b: '"""', e: '"""', c: [c.BE, e]}, {
        cN: "string",
        b: '"',
        e: '"',
        c: [c.BE, e],
        r: 0
    }, {cN: "regexp", b: "///", e: "///", c: [c.HCM]}, {cN: "regexp", b: "//[gim]*", r: 0}, {
        cN: "regexp",
        b: "/\\S(\\\\.|[^\\n])*?/[gim]*(?=\\s|\\W|$)"
...
hljs.LANGUAGES.cpp = function (a) {
    ...
    return {
        ...
        }, a.CNM, {cN: "preprocessor", b: "#", e: "$", c: [{b: "<", e: ">", i: "\\n"}, a.CLCM]}, {
            cN: "stl_container",
...
hljs.LANGUAGES.delphi = function (b) {
    ...
    var h = {
        ...
        c: [{cN: "title", b: b.IR}, {cN: "params", b: "\\(", e: "\\)", k: f, c: [c, d]}, a, g]
    };
    return {
        cI: true,
        k: f,
        i: '("|\\$[G-Zg-z]|\\/\\*|</)',
        c: [a, g, b.CLCM, c, d, b.NM, h, {cN: "class", b: "=\\bclass\\b", e: "end;", k: e, c: [c, d, a, g, b.CLCM, h]}]
    }
}(hljs);
...
hljs.LANGUAGES.django = function (a) {
    var b = {
        cN: "filter",
        b: /\|[A-Za-z]+\:?/,
...
hljs.LANGUAGES.fsharp = function (a) {
    return {
        ...
        c: [{cN: "string", b: '@"', e: '"', c: [{b: '""'}]}, {cN: "string", b: '"""', e: '"""'}, {
            ...
            b: "\\(\\*",
            e: "\\*\\)"
        }, {cN: "class", bWK: true, e: "\\(|=|$", k: "type", c: [{cN: "title", b: a.UIR}]}, {
            cN: "annotation",
            b: "\\[<",
            e: ">\\]"
...
hljs.LANGUAGES.ruby = function (e) {
    ...
    var b = [{cN: "string", b: "'", e: "'", c: i, r: 0}, {cN: "string", b: '"', e: '"', c: i, r: 0}, {
        ...
        c: i,
        r: 10
    }, {cN: "string", b: /\B\?(\\\d{1,3}|\\x[A-Fa-f0-9]{1,2}|\\u[A-Fa-f0-9]{4}|\\?\S)\b/}];
    var h = {
        cN: "function",
        bWK: true,
        e: " |$|;",
...
hljs.LANGUAGES.haml = function (a) {
    return {
        ...
        c: [{cN: "doctype", b: "^!!!( (5|1\\.1|Strict|Frameset|Basic|Mobile|RDFa|XML\\b.*))?$", r: 10}, {
            ...
            cN: "tag",
            b: "^\\s*%",
            c: [{cN: "title", b: "\\w+", r: 0}, {cN: "value", b: "[#\\.]\\w+", r: 0}, {
                b: "{\\s*",
                e: "\\s*}",
                eE: true,
                c: [{
                    ...
                    eW: true,
                    r: 0,
                    c: [{cN: "symbol", b: ":\\w+", r: 0}, {cN: "string", b: '"', e: '"', r: 0}, {
                        cN: "string",
                        b: "'",
                        e: "'",
                        r: 0
                ...
                c: [{
                    ...
                    eW: true,
                    r: 0,
                    c: [{cN: "attribute", b: "\\w+", r: 0}, {cN: "string", b: '"', e: '"', r: 0}, {
                        cN: "string",
                        b: "'",
                        e: "'",
                        r: 0
            ...
            r: 10
        }, {cN: "bullet", b: "^\\s*[=~]\\s*", r: 0}, {b: "#{", starts: {e: "}", sL: "ruby"}, r: 0}]
    }
}(hljs);
hljs.LANGUAGES.handlebars = function (b) {
...
hljs.LANGUAGES.haskell = function (f) {
    var h = {cN: "comment", b: "--", e: "$"};
    var g = {cN: "comment", c: ["self"], b: "{-", e: "-}"};
    var e = {cN: "pragma", b: "{-#", e: "#-}"};
    ...
    var c = {
        ...
        e: "\\)",
        i: '"',
        c: [e, h, g, b, {cN: "type", b: "\\b[A-Z][\\w]*(\\((\\.\\.|,|\\w+)\\))?"}, {cN: "title", b: "[_a-z][\\w']*"}]
    };
    ...
    return {
        ...
        c: [{cN: "module", b: "\\bmodule ", e: "where", k: "module where", c: [c, g], i: "\\W\\.|;"}, {
            cN: "import",
            b: "\\bimport ",
            e: "$",
            ...
            c: [e, h, g, d, c, a]
        }, {cN: "default", b: "\\bdefault ", e: "$", k: "default", c: [d, c, h, g]}, {
            cN: "infix",
            b: "\\b(infix |infixl |infixr )",
            e: "$",
            k: "infix infixl infixr",
            c: [f.CNM, h, g]
        }, {
            cN: "foreign",
            b: "\\bforeign ",
            ...
            c: [d, f.QSM, h, g]
        }, {cN: "shebang", b: "#!\\/usr\\/bin\\/env runhaskell", e: "$"}, e, h, g, b, f.QSM, f.CNM, d, {
            cN: "title",
            b: "^[_a-z][\\w']*"
        }, {b: "->|<-"}]
    }
...
hljs.LANGUAGES.lasso = function (d) {
    ...
    var f = [d.CLCM, {
        ...
        b: "`",
        e: "`"
    }, {cN: "variable", b: "[#$]" + b}, {cN: "variable", b: "#", e: "\\d+", i: "\\W"}, {
        cN: "tag",
        b: "::\\s*",
        e: b,
        i: "\\W"
    }, {cN: "attribute", b: "\\.\\.\\.|-" + d.UIR}, {cN: "subst", b: "->\\s*", c: [h]}, {
        cN: "subst",
        b: ":=|[-+*/%=<>&|!?\\\\]+",
        r: 0
    ...
    return {
        ...
        c: [{
            ...
            b: c,
            r: 0,
            starts: {cN: "markup", e: "\\[|" + i, rE: true, c: [a]}
        }, j, e, {
            cN: "preprocessor",
...
hljs.LANGUAGES.lisp = function (i) {
    ...
    var d = [{cN: "number", b: m, r: 0}, {cN: "number", b: "#b[0-1]+(/[0-1]+)?"}, {
        cN: "number",
        b: "#o[0-7]+(/[0-7]+)?"
    }, {cN: "number", b: "#x[0-9a-f]+(/[0-9a-f]+)?"}, {cN: "number", b: "#c\\(" + m + " +" + m, e: "\\)"}];
    ...
    var c = {cN: "quoted", b: "\\(quote ", e: "\\)", k: {title: "quote"}, c: d.concat([h, g, o, b])};
    var j = {cN: "list", b: "\\(", e: "\\)"};
    var f = {eW: true, r: 0};
    j.c = [{cN: "title", b: l}, f];
...
hljs.LANGUAGES.livecodeserver = function (a) {
    var f = {cN: "variable", b: "\\b[gtps][A-Z]+[A-Za-z0-9_\\-]*\\b|\\$_[A-Z]+", r: 0};
    var b = [a.inherit(a.ASM), a.inherit(a.QSM)];
    var d = [a.inherit(a.CBLCLM), {cN: "comment", b: "--", e: "$"}, {
        cN: "comment",
        b: "[^:]//",
        e: "\\n"
    }, {cN: "comment", b: "#", e: "\\n"}];
    var c = [a.BNM, a.CNM];
    var e = [{cN: "title", b: "\\b_*rig[A-Z]+[A-Za-z0-9_\\-]*"}, {cN: "title", b: "\\b_[a-z0-9\\-]+"}];
    return {
        cI: false,
        k: {
        ...
        c: [f, {cN: "keyword", b: "\\bend\\sif\\b"}, {
            cN: "function",
            bWK: true,
            e: "$",
            k: "function",
            c: [f, {cN: "title", b: "\\b([A-Za-z0-9_\\-]+)\\b"}].concat(b).concat(c).concat(e)
        }, {
            cN: "function",
            bWK: true,
            e: "$",
            k: "end",
            c: [{cN: "title", b: "\\b([A-Za-z0-9_\\-]+)\\b"}].concat(e)
        }, {
            cN: "command",
            bWK: true,
            e: "$",
            ...
            cN: "preprocessor",
            b: "<\\?"
        }, {cN: "preprocessor", b: "\\?>"}].concat(d).concat(b).concat(c).concat(e),
        i: ";$|^\\[|^="
    }
}(hljs);
...
hljs.LANGUAGES.matlab = function (a) {
    var b = [a.CNM, {cN: "string", b: "'", e: "'", c: [a.BE, {b: "''"}], r: 0}];
    return {
        k: {
        ...
        c: [{
            ...
            e: "$",
            k: "function",
            c: [{cN: "title", b: a.UIR}, {cN: "params", b: "\\(", e: "\\)"}, {cN: "params", b: "\\[", e: "\\]"}]
        }, {cN: "transposed_variable", b: "[a-zA-Z_][a-zA-Z_0-9]*('+[\\.']*|[\\.']+)", e: ""}, {
            cN: "matrix",
            b: "\\[",
            e: "\\]'*[\\.']*",
            c: b
        }, {cN: "cell", b: "\\{", e: "\\}'*[\\.']*", c: b}, {cN: "comment", b: "\\%", e: "$"}].concat(b)
    }
}(hljs);
hljs.LANGUAGES.mel = function (a) {
    return {
        ...
        c: [a.CNM, a.ASM, a.QSM, {cN: "string", b: "`", e: "`", c: [a.BE]}, {
            ...
            b: "\\$\\d",
            r: 5
        }, {cN: "variable", b: "[\\$\\%\\@\\*](\\^\\w\\b|#\\w+|[^\\s\\w{]|{\\w+}|\\w+)"}, a.CLCM, a.CBLCLM]
    }
}(hljs);
...
hljs.LANGUAGES.nginx = function (b) {
    var c = [{cN: "variable", b: "\\$\\d+"}, {cN: "variable", b: "\\${", e: "}"}, {
        cN: "variable",
        b: "[\\$\\@]" + b.UIR
    }];
    var a = {
        ...
        r: 0,
        i: "=>",
        c: [b.HCM, {cN: "string", b: '"', e: '"', c: [b.BE].concat(c), r: 0}, {
            cN: "string",
            b: "'",
            e: "'",
            c: [b.BE].concat(c),
            ...
            rE: true,
            c: [b.BE].concat(c)
        }, {cN: "regexp", b: "~\\*?\\s+", e: "\\s|{|;", rE: true, c: [b.BE].concat(c)}, {
            cN: "regexp",
            b: "\\*(\\.[a-z\\-]+)+",
            c: [b.BE].concat(c)
        ...
        }, {cN: "number", b: "\\b\\d+[kKmMgGdshdwy]*\\b", r: 0}].concat(c)
    };
    return {
        c: [b.HCM, {b: b.UIR + "\\s", e: ";|{", rB: true, c: [{cN: "title", b: b.UIR, starts: a}], r: 0}],
        i: "[^\\s\\}]"
    }
}(hljs);
...
hljs.LANGUAGES.ocaml = function (a) {
    return {
        k: {
...
hljs.LANGUAGES.php = function (a) {
    ...
    return {
        ...
        }, {cN: "comment", b: "__halt_compiler.+?;", eW: true, k: "__halt_compiler", l: a.UIR}, {
            cN: "string",
            b: "<<<['\"]?\\w+['\"]?$",
            e: "^\\w+;",
            c: [a.BE]
...
hljs.LANGUAGES.rsl = function (a) {
    return {
        ...
        }, {cN: "shading", bWK: true, e: "\\(", k: "illuminate illuminance gather"}]
    }
}(hljs);
...
hljs.LANGUAGES.rust = function (b) {
    ...
    return {
        ...
        c: [b.CLCM, b.CBLCLM, b.inherit(b.QSM, {i: null}), b.ASM, c, {
            ...
            k: "fn",
            c: [d]
        }, {cN: "preprocessor", b: "#\\[", e: "\\]"}, {bWK: true, e: "(=|<)", k: "type", c: [d], i: "\\S"}, {
            bWK: true,
            e: "({|<)",
            k: "trait enum",
            c: [d],
...
hljs.LANGUAGES.scilab = function (a) {
    var b = [a.CNM, {cN: "string", b: "'|\"", e: "'|\"", c: [a.BE, {b: "''"}], r: 0}];
    return {
        k: {
        ...
        c: [{
            ...
            c: [{cN: "title", b: a.UIR}, {cN: "params", b: "\\(", e: "\\)"},],
        }, {cN: "transposed_variable", b: "[a-zA-Z_][a-zA-Z_0-9]*('+[\\.']*|[\\.']+)", e: ""}, {
            cN: "matrix",
            b: "\\[",
            e: "\\]'*[\\.']*",
...
hljs.LANGUAGES.smalltalk = function (a) {
    ...
    return {
        ...
        c: [{cN: "comment", b: '"', e: '"', r: 0}, a.ASM, {
            cN: "class",
            b: "\\b[A-Z][A-Za-z0-9_]*",
            r: 0
        }, {cN: "method", b: b + ":"}, a.CNM, c, d, {
            cN: "localvars",
            b: "\\|\\s*" + b + "(\\s+" + b + ")*\\s*\\|"
...
hljs.LANGUAGES.vbscript = function (a) {
    return {
        ...
        i: "//",
        c: [a.inherit(a.QSM, {c: [{b: '""'}]}), {cN: "comment", b: "'", e: "$"}, a.CNM]
    }
}(hljs);
